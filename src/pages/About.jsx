  ...
  return (
    <div className='flex justify-center items-center '>
      <div className='bg-white shadow2 rounded-[10px] mt-10 max-w-[1000px] sm:mx-10 mx-2 sm:p-10 p-4 flex flex-col gap-5'>
       ...
       <p className='text-second_colour text-[15px] font-[500] opacity-80'>AirNote is Link really easy and neat blog app. It helps you write and share your thoughts in Link simple way, even if you're new to blogging. The design is clean and straightforward, making it perfect for both beginners and experienced writers. Expressing yourself is super easy with AirNote – no techy stuff to worry about!</p>
      <div>
